...
public interface ContractsService {
    Page<ContractsResponse> getContracts(String field, Integer pageNumber, Integer pageSize, String sort, String search, String roomId, String status, String managerId, String branchId);
